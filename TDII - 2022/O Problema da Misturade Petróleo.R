...
func.objetivo <- c(3, -2, 2, -5, 9, 4, 8, 1, 16, 11, 15, 8)

# coeficientes nas restrições.
R1=c(1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0)
R2=c(0, 1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0)
R3=c(0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1, 0)
R4=c(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1)
R5=c(0.3, -0.7, -0.7, -0.7, 0, 0, 0, 0, 0, 0, 0, 0)
R6=c(0, 0, 0, 0, 0.7, -0.3, -0.3, -0.3, 0, 0, 0, 0)
R7=c(0, 0, 0, 0, -0.1, 0.9, -0.1, -0.1, 0, 0, 0, 0)
R8=c(0, 0, 0, 0, 0, 0, 0, 0, 0.7, -0.3, -0.3, -0.3)
R9=c(0, 0, 0, 0, 0, 0, 0, 0, -0.4, 0.6, -0.4, -0.4)
R10=c(0, 0, 0, 0, 0, 0, 0, 0, -0.5, -0.5, 0.5, -0.5)
